...
------|---------- |-----------------------|----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------| 
Home  | H-1.0     | Gain access to landing page    | **As a** user **I want** to access the Rosie's landing page  **so that** I can gain access to the site content.| **Given** that the user is on Rosie Landing page, **When** they click on the Home Nav link **then** the system  will take them to the About me section of Rosie website. |     M   |
